...
COPY  ./packages/ducatus-bitcore-wallet-client/package.json ./packages/ducatus-bitcore-wallet-client/package.json
COPY  ./packages/ducatus-bitcore-wallet-client/package-lock.json ./packages/ducatus-bitcore-wallet-client/package-lock.json
